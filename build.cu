...
DEFINE_string(onnx_file, "modnet-sim.onnx", "onnx file path");
...
DEFINE_int32(input_h, 288, "network input height");
DEFINE_int32(input_w, 512, "network input width");
DEFINE_int32(input_c, 3, "network input channel");
DEFINE_bool(int8, false, "use int8 mode");
DEFINE_string(model_name, "modnet", "model name");
...
int main(int argc, char **argv)
{
    ...
    else
    {
        ...
        NetPreprocessor preprocess = nullptr;
